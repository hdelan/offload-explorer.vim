...
function! offloadexplorer#ShowIR(IRformat)
  ...
  let base_command = join(["!cd ", dpcpp_tmp_ir_folder, " && ", g:offload_explorer_cxx, " -fsycl -fsycl-range-rounding=disable -mllvm -enable-global-offset=false -fsycl-targets=", targets, " ", working_file_full_path], "")
